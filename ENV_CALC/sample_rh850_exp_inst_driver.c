...
/*vcast_header_expansion_start:sample_rh850_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
---------------------------------------------
*/
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/x86_64-w64-mingw32/include/stdlib.h*/
/**
...
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/x86_64-w64-mingw32/include/setjmp.h*/
/**
 * This file has no copyright assigned and is placed in the Public Domain.
 * This file is part of the mingw-w64 runtime package.
 * No warranty is given; refer to the file DISCLAIMER.PD within this package.
...
#pragma pack(pop)
/*vcast_header_collapse_end*/
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/x86_64-w64-mingw32/include/stdio.h*/
/**
 * This file has no copyright assigned and is placed in the Public Domain.
 * This file is part of the mingw-w64 runtime package.
 * No warranty is given; refer to the file DISCLAIMER.PD within this package.
...
/*vcast_header_collapse_end*/
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/x86_64-w64-mingw32/include/string.h*/
/**
 * This file has no copyright assigned and is placed in the Public Domain.
 * This file is part of the mingw-w64 runtime package.
 * No warranty is given; refer to the file DISCLAIMER.PD within this package.
...
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/lib/gcc/x86_64-w64-mingw32/10.2.0/include-fixed/limits.h*/
/* Copyright (C) 1992-2020 Free Software Foundation, Inc.
...
/* We use _GCC_LIMITS_H_ because we want this not to match
   any macros that the system's limits.h uses for its own purposes.  */
/*vcast_header_collapse_end*/
/*vcast_header_collapse_start:C:/Tools/VCAST/MinGW/lib/gcc/x86_64-w64-mingw32/10.2.0/include/float.h*/
...
__attribute__ ((__dllimport__)) unsigned int __attribute__((__cdecl__)) __attribute__ ((__nothrow__)) _clearfp (void); /* Clear the FPU status word */
__attribute__ ((__dllimport__)) unsigned int __attribute__((__cdecl__)) __attribute__ ((__nothrow__)) _statusfp (void); /* Report the FPU status word */
/*
...
long long VCAST_PARAM_AS_LONGEST_INT(void);
unsigned long long VCAST_PARAM_AS_LONGEST_UNSIGNED(void);
...
void VCAST_TI_RANGE_DATA_9 ( void ) {
  ...
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,(-0x7fffffff - 1) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,((-0x7fffffff - 1) / 2) + (0x7fffffff / 2) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,0x7fffffff );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
}
/* Include the file which contains function implementations
for stub processing and value/expected user code */
/*vcast_header_expansion_start:sample_rh850_uc.c*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
