 ...
 *
 * Path: D:/python-mcp-server/vcastagent/project/vectorcast_env/ENV_CALC/ENV_CALC/S0000008.c
 *
 * Type: not-stubbed
 *
 * Unit Number: 8
...
void VCAST_TI_8_1 ( int *vcast_param ) 
{
  ...
  case vCAST_SET_VAL :
    *vcast_param = ( int  ) VCAST_PARAM_AS_LONGEST_INT();
    break;
...
void VCAST_TI_8_2 ( float *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_2 */
...
void VCAST_TI_8_2 ( float *vcast_param ) 
{
  switch (vCAST_COMMAND) {
    ...
    case vCAST_KEEP_VAL:
      break; /* KEEP doesn't do anything */
  case vCAST_SET_VAL :
    *vcast_param = ( float  ) VCAST_PARAM_AS_LONGEST_FLOAT();
    break;
  case vCAST_FIRST_VAL :
    *vcast_param = -(FLT_MAX);
    break;
...
/* An array */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_3 ( char vcast_param[8] ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_3 */
...
{
  {
    int VCAST_TI_8_3_array_index = 0;
    int VCAST_TI_8_3_index = 0;
    int VCAST_TI_8_3_first, VCAST_TI_8_3_last;
    int VCAST_TI_8_3_local_field = 0;
    int VCAST_TI_8_3_value_printed = 0;
    int VCAST_TI_8_3_is_string = (VCAST_FIND_INDEX()==-1);

    vcast_get_range_value (&VCAST_TI_8_3_first, &VCAST_TI_8_3_last);
    VCAST_TI_8_3_local_field = vCAST_DATA_FIELD;
    {
      int VCAST_TI_8_3_upper = 8;
      for (VCAST_TI_8_3_array_index=0; VCAST_TI_8_3_array_index< VCAST_TI_8_3_upper; VCAST_TI_8_3_array_index++){
        if ( (VCAST_TI_8_3_index >= VCAST_TI_8_3_first) && ( VCAST_TI_8_3_index <= VCAST_TI_8_3_last)){
          if ( VCAST_TI_8_3_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_8_3_upper);
          else
            VCAST_TI_8_4 ( &(vcast_param[VCAST_TI_8_3_index]));
          VCAST_TI_8_3_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_8_3_local_field;
        } /* if */
        if (VCAST_TI_8_3_index >= VCAST_TI_8_3_last)
          break;
        VCAST_TI_8_3_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_8_3_value_printed))
...
{
  {
    ...
    vcast_get_range_value (&VCAST_TI_8_5_first, &VCAST_TI_8_5_last);
    VCAST_TI_8_5_local_field = vCAST_DATA_FIELD;
    {
      ...
      for (VCAST_TI_8_5_array_index=0; VCAST_TI_8_5_array_index< VCAST_TI_8_5_upper; VCAST_TI_8_5_array_index++){
        if ( (VCAST_TI_8_5_index >= VCAST_TI_8_5_first) && ( VCAST_TI_8_5_index <= VCAST_TI_8_5_last)){
          VCAST_TI_8_1 ( &(vcast_param[VCAST_TI_8_5_index]));
  ...
  switch (vCAST_COMMAND) {
    case vCAST_PRINT :
      ...
      case vCAST_KEEP_VAL:
        break; /* KEEP doesn't do anything */
    case vCAST_SET_VAL :
      *vcast_param = ( char  ) VCAST_PARAM_AS_LONGEST_INT();
      break;
    case vCAST_FIRST_VAL :
...
#define VCAST_TI_VECTOR_TYPE "NEW_VECTOR\n"
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
#endif
  /* Range Data for TI (array) VCAST_TI_8_3 */
